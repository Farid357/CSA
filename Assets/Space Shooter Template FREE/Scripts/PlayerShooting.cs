...
public class Guns
{
    public UnityEngine.GameObject rightGun, leftGun, centralGun;
...
public class PlayerShooting : MonoBehaviour {
    ...
    void CreateLazerShot(UnityEngine.GameObject lazer, Vector3 pos, Vector3 rot) //translating 'pooled' lazer shot to the defined position in the defined rotation
    {
