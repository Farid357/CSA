...
public class LevelController : MonoBehaviour {
    ...
    public UnityEngine.GameObject[] planets;
    public float timeBetweenPlanets;
    public float planetsSpeed;
    List<UnityEngine.GameObject> planetsList = new List<UnityEngine.GameObject>();
    ...
    IEnumerator CreateEnemyWave(float delay, UnityEngine.GameObject Wave) 
    {
        if (delay != 0)
    ...
    IEnumerator PlanetsCreation()
    {
        ...
        while (true)
        {
            ...
            UnityEngine.GameObject newPlanet = Instantiate(planetsList[randomIndex]);
